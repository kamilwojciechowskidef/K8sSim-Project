...
func (pc *Scheduler) RunOnceV2(snapshot *api.ClusterInfo, acts []framework.Action, tiers []conf.Tier, configurations []conf.Configuration) {

	ssn := framework.OpenSessionV2(snapshot, tiers, configurations)
